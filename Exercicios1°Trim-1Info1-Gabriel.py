...
def media_final_aprovado_reprovado(p1, p2, ep1, ep2):
    ...
    nota1= (p1*0.7)+(ep1*0.3)
    nota2= (p2*0.7)+(ep2 *0.3)
    media_final_aprovado_reprovado= (nota1+nota2)/2
...
def salario(valor_hora, horas_mensais):
    ...
    salario -= (salario*0.08)+(salario*0.11)+(salario*0.05)  
    return salario
...
def media_temperaturas(temperaturas):
    ...
    return round(media_temperaturas,1)
